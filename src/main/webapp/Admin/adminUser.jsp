...
<meta charset="ISO-8859-1">
 ...
 <script type="text/javascript">
	...
	function submitFunctionchangeAgent() {
		document.getElementById("changeagent").submit();
	}
</script>       
                            ...
                            <ul>
    							...
    							<form id="adminU" action="adminUser" method="get">
	                                ...
	                                text-decoration:none" href="#" onclick="submitFunctionAdminUser()" >
	                                    <li style="background-color: #F0F0F0; color: black;">USER</li>
    							</form>
                            ...
                            <c:forEach var="u" items="${userInfo}">
                              ...
                              <Li class="tickets" style="padding-right: 0; padding-left: 0; width: 1200px ;">
                                ...
                                <div class="row ticket-row">
                                    ...
                                    <div class="col-md-3" > 
                                    <form id="changeagent" action="agentchange" method="get">
                                    	<input type="hidden" name="uid" value="${u.userId}">
                                    	<a>
                                    		<button class="btn btn-primary" style ="background-color: #191f45; color: #d8bfd8">Change as agent</button>
                                    	</a>
                                    ...
                                    <div class="col-md-2">
                                      <form id="remove" action="remove" method="get">
                                    		<input type="hidden" name="uid" value="${u.userId}">
                                    		<a>
                                    			<button type="submit" class="btn btn-primary" style ="background-color: rgb(212, 5, 5); color: white">Remove User</button>
                                    		</a>
                                    	</form>
                                    </div>
