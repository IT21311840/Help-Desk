                            ...
                            <ul>
								...
								<form id="ticketsTrash" action="trash" method="get">
	                                ...
	                                text-decoration:none" href="#" onclick="submitFunctionTrash()">
	                                    <li style="background-color: #F0F0F0; color: black;" >TRASH</li>
	                                </a>
								</form>
										...
										<div class="col-md-6">
											...
											<form action="deleteperm" method="get"> 
												<input type="hidden" value="${t.ticketId}" name="ticketId" >
													<button class="delete-btn btn btn-default btn-block  btn-danger ">
													    DELETE PERMENANTLY<i class="fas fa-trash"></i>
												    </button>
											</form>
										</div>
